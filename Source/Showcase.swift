...
extension Showcase {
    ...
    /**
           ...
           # Example #
          ```
           if let sum = self.setDefaultProperties() {
    ...
    */
    ...
    private func addBackground() {
        ...
        case .circle:
            ...
            //getOuterCircleCenterPoint(for: targetCopyView)
            guard let center = targetRippleView?.center else {
        ...
        guard let backgroundPromptColor = backgroundPromptColor else {
            print("backgroundPromptColor is null")
            return }
    ...
    */
    ...
    private func addTargetHolder(at center: CGPoint) {
        ...
        guard let targetHolderView = targetHolderView else {
            print("targetHolderView is null")
            return }
    ...
    private func addTarget(at center: CGPoint) {
        ...
        guard let targetCopyView = targetCopyView else {
            print("targetCopyView is null")
            return }
        if shouldSetTintColor {
            guard let targetTintColor = targetTintColor else {
                print("targetTintColor is null")
                return }
